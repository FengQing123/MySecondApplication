...
import com.example.jiaw2.mysecondapplication.Activity.LicenseKeyboardActivity;
    ...
    private KeyboardView.OnKeyboardActionListener listener = new KeyboardView.OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            if(primaryCode == 112){ //xml中定义的删除键值为112
                ...
                intent.putExtra(LicenseKeyboardActivity.INPUT_LICENSE_KEY, license);
                intent.setAction(LicenseKeyboardActivity.INPUT_LICENSE_COMPLETE);
