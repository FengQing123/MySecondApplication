...
public class RoundDialView extends View {
    ...
    public RoundDialView(Context context) {
        this(context, null);
    }

    public RoundDialView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundDialView(final Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        maxNum = array.getInt(R.styleable.RoundDialView_maxNum, 500);
        startAngle = array.getInt(R.styleable.RoundDialView_startAngle, 160);
        sweepAngle = array.getInt(R.styleable.RoundDialView_sweepAngle, 220);
        //内外圆的宽度
